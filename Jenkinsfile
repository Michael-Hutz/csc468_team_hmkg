        ...
        stage ('Deploy') {
            ...
            steps {
                sshagent(credentials: ['cloudlab']) {
                    ...
                    sh 'ssh -o StrictHostKeyChecking=no MH824134@clnodevm157-1.clemson.cloudlab.us kubectl apply -f /users/MH824134/rngcrypto.yaml -n jenkins'
                    sh 'ssh -o StrictHostKeyChecking=no MH824134@clnodevm157-1.clemson.cloudlab.us kubectl apply -f /users/MH824134/rngcrypto-service.yaml -n jenkins'                                        
                }
            }
        }
    }
